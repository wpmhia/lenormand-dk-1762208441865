                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Switch
                          ...
                          className="data-[state=unchecked]:bg-slate-700 data-[state=unchecked]:border-slate-600 data-[state=unchecked]:thumb:bg-slate-200 data-[state=checked]:bg-rose-600 data-[state=checked]:border-rose-500 data-[state=checked]:thumb:bg-white data-[state=checked]:shadow-rose-500/50 hover:data-[state=unchecked]:bg-slate-600 hover:data-[state=checked]:bg-rose-500 focus-visible:ring-rose-400 focus-visible:ring-offset-2 transition-all duration-200"
                        />
                      </TooltipTrigger>
